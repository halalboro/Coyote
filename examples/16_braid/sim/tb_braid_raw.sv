/**
 * braid_framer_raw: alignment and frame round-trip.
 *
...
module tb_braid_raw;
    ...
    //      constant W_ALIGN every cycle -- braid_framer_raw drives
    ...
    braid_framer_raw #(.LOSS_COUNT(64)) u_framer (
    ...
    initial begin
        ...
        // no non-zero rotation of 5C3D_2A96 equals itself (tb_braid_align
